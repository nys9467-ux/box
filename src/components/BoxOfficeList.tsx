...
export default function BoxOfficeList({ items, onSelectMovie }: BoxOfficeListProps) {
  if (items.length === 0) {
    return (
      <div 
        id="empty-state" 
      ...
      >
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
          선택한 날짜에 조회 가능한 박스오피스 정보가 존재하지 않습니다. 다른 날짜를 선택해보세요.
        </p>
      </div>
    );
  }
  ...
  return (
    <div id="box-office-list" className="space-y-3">
      {/* Table Headers for Desktop */}
      <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 border-b border-gray-100 dark:border-gray-800 text-xs font-semibold tracking-wider text-gray-400 dark:text-gray-500 uppercase">
      ...
      {items.map((movie) => {
        ...
        return (
          <div
            ...
            className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 items-center p-4 md:px-6 md:py-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800/60 rounded-2xl shadow-xs hover:border-blue-500/50 dark:hover:border-blue-500/50 hover:shadow-md cursor-pointer transition-all duration-300 group hover:-translate-y-[2px]"
          >
            {/* Rank column */}
            ...
            <div className="col-span-1 md:col-span-5 flex flex-col min-w-0 pr-4">
              <div className="flex items-center gap-2 mb-1">
                <h4 className="text-base md:text-md font-bold text-gray-800 dark:text-gray-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-150 truncate leading-snug">
                  {movie.movieNm}
                </h4>
            ...
            <div className="col-span-1 md:col-span-2 flex justify-between md:justify-end items-center text-sm">
              ...
              <div className="flex flex-col items-end">
                ...
                {/* Audience gain/loss intensity indicator */}
